...
// CAMERA MODE
var cameraMode = 'third'; // 'third' | 'first'
...
function updatePlane(){
  ...
  airplaneHolder.position.y += (targetY-airplaneHolder.position.y)*deltaTime*game.planeMoveSensivity;
  airplaneHolder.position.x += (targetX-airplaneHolder.position.x)*deltaTime*game.planeMoveSensivity;

  airplane.mesh.rotation.z = (targetY-airplaneHolder.position.y)*deltaTime*game.planeRotXSensivity;
  airplane.mesh.rotation.x = (airplaneHolder.position.y-targetY)*deltaTime*game.planeRotZSensivity;
  if (cameraMode === 'third'){
